...
namespace ResourceEmbedder.SourceGenerator
{
    [Generator]
    public class ResourceEmbedderGenerator : ISourceGenerator
    {
        public void Initialize(GeneratorInitializationContext context)
        {
            context.RegisterForPostInitialization(i => i.AddSource("ResourceEmbedderILGenerated.cs", code));
        }
...
namespace ResourceEmbedderCompilerGenerated
{
    ...
    /// </summary>
    internal static class ResourceEmbedderILInjected
    {
        /// <summary>
